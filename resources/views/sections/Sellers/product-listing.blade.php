        ...
        <div class="py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-6 m-4">
            ...
            <div class="container h-full w-full flex flex-col justify-center items-center gap-4">
                <form action="" class="justify-center flex flex-col items-center w-[30rem]">
                    ...
                    <div class="container flex flex-col items-center mb-2">
                        <label for="details" class="font-montserrat font-semibold text-lg text-grey-100 text-left self-start">Product Details</label>
                        <input type="text" name="details" class="border border-grey-100 focus:border-black rounded-md h-9 w-full indent-2 font-montserrat text-sm" placeholder="">
                    </div>
                    <div class="container flex flex-col items-center mb-2">
