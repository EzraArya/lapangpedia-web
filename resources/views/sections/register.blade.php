                ...
                <div class="container h-full w-full flex flex-col justify-center items-center gap-4">
                    <form action="" class="justify-center flex flex-col items-center w-[30rem]">
                        ...
                        <div class="container flex flex-col items-center mb-2">
                            ...
                            <input type="date" name="dob" class="border border-grey-100 focus:border-black rounded-md h-9 w-full indent-2 font-montserrat text-sm">
                        </div>
                        <div class="container flex flex-col items-center mb-2">
                            <label for="password" class="font-montserrat font-semibold text-lg text-grey-100 text-left self-start">Password</label>
                            <input type="text" name="password" class="border border-grey-100 focus:border-black rounded-md h-9 w-full indent-2 font-montserrat text-sm" placeholder="Password">
                        </div>
                        <div class="container flex flex-col items-center mb-3">
                            ...
                            <input type="text" name="confirm-password" class="border border-grey-100 focus:border-black rounded-md h-9 w-full indent-2 font-montserrat text-sm" placeholder="Confirm Password">
                        </div>
